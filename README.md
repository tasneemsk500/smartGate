# smartGate
The website I used to download my Arduino IDE platform:
https://docs.arduino.cc/programming/

In this project, I build a prototype of a smart gate that mimics the real-world smart gate system at an apartment complex.
